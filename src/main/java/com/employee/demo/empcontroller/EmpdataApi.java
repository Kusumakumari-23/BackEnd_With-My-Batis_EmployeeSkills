...
@Api(value = "empdata", description = "the empdata API")
...
//    ResponseEntity<Employee> addEmployee(@ApiParam(value = "employee object that needs to be added to data base" ,required=true )  @Valid @RequestBody Employee employee);
    ...
    ResponseEntity<Void> updateEmployee(@ApiParam(value = "update by empId",required=true) @PathVariable("empId") Integer empId,@ApiParam(value = "employee object needs to update in database" ,required=true )  @Valid @RequestBody Employee employee);
    ...
    @RequestMapping(value = "/empdata/updateSkill/{empId}",
        ...
        consumes = { "application/json" },
        method = RequestMethod.PUT)
    ResponseEntity<Void> updateSkill(@ApiParam(value = "update by empId",required=true) @PathVariable("empId") Integer empId,@ApiParam(value = "skill object needs to update in database" ,required=true )  @Valid @RequestBody Skill skill);
